...
def prediction():
    ...
    if pred[0] == 0:
        ...
        return "It seems to be safe input. Allowing the query to execute on DB. \n DB Response is {}".format(dbresponse)
        #return "It seems to be safe input. Allowing the query to execute on DB."
    else:
        print("ALERT :::: This can be SQL injection. Blocking the query")
        return "ALERT :::: This can be SQL injection. Blocking the query"
